...
class MeshVertex : public Vertex<MeshUsedTypes, vertex::Coord3f, vertex::TexCoord2f, vertex::Normal3f, vertex::BitFlags> {};
class MeshFace : public Face<MeshUsedTypes, face::VertexRef, face::FFAdj, face::WedgeTexCoord2f, face::Color4b, face::Qualityf, face::BitFlags> {};
